...
<head>
  ...
  <link rel="stylesheet" href="css/gadgets_don_form.css">
</head>

<body>
  <div class="container">
    <div class="row register">
      <h1> Donate Gadgets here....</h1>
      <div class="col-sm-3">
      </div>
      ...
      <div class="col-sm-6 reg">
        <form action="" class="form-horizontal hr" method="post">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input name="Mobno" type="number" class="form-control " id="uname" placeholder="Enter Your  MobileNumber">
            </div>
          </div>
          ...
          <div class="form-group">
            <label for="Cat-Gat" class="control-label col-sm-4"> Category Of Gadgets</label>
            <div class="col-sm-8">
              <input name="Catgadget" type="text" class="form-control " id="uname" placeholder="Enter the Category oF Gadgets. e.g.Mobile,Watch,Calculator,...">
            </div>
          </div>

          <div class="form-group">
            <label for="No.Gadgets" class="control-label col-sm-4"> Number Of Gadgets</label>
            <div class="col-sm-8">
              <input name="No_Gadget" type="text" class="form-control " id="uname" placeholder="Enter Number of Gadget">
            </div>
          </div>
...
if(isset($_POST["sub-btn-1"])){
  if(isset($_SESSION["login-user"])){
    ...
    $mobno=$_POST["Mobno"];
    $add=$_POST["Add"];
    $catbook=$_POST["Catgadget"];
    $nogadget=$_POST["No_Gadget"];
    $cp1 = "INSERT INTO `gadget_don`(`FName`, `LName`, `Email`, `Mob.No.`, `Address`, `Cat-gadget`, `No.Gadget`) VALUES ('$fname','$lname','$email','$mobno','$add','$catbook','$nogadget')";
            $cp2 = mysqli_query($conn,$cp1);
            if($cp2){
                echo '<script type="text/javascript">';
                echo ' alert(" Successfully")';  //data added..
                echo '</script>';
